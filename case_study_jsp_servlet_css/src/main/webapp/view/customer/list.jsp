...
<head>
    ...
    <link rel="stylesheet" href="/DataTables-1.12.1/css/dataTables.bootstrap.min.css">
    <link rel="stylesheet"
...
<div class="container-fluid position-relative">
    <div class="row">
        <div class="col-lg-10 d-flex justify-content-start  position-absolute" style="top: 10%">
            <div class="row">
                <div class="col-l-12 ps-2 pe-2 text-dark">
                    ...
                    <table class="table table-hover fw-bold text-dark" id="list">
                        <thead>
        ...
        <div class="col-lg-10 mt-3 pt-3 pb-3 d-flex justify-content-center">
...
<script src="../../DataTables-1.12.1/js/dataTables.bootstrap.min.js"></script>
